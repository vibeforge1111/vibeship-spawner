...
server.setRequestHandler(ListToolsRequestSchema, async () => {
  return {
    tools: [
      {
        name: 'create_project',
        description: 'Create a new vibeship orchestrator project. Can use a gist ID from the web configurator, a template name (saas, marketplace, ai-app, web3, tool), or a custom config.',
        inputSchema: {
          type: 'object',
          properties: {
            gist_id: {
      ...
      },
      {
        ...
        description: 'Check if the environment has all required dependencies for vibeship orchestrator (Node.js, Claude CLI, etc.)',
        inputSchema: {
          type: 'object',
          properties: {}
        }
